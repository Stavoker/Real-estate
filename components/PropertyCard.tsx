      ...
      >
        <motion.div
          ...
          className={cn(
            ...
            expanded
              ? "aspect-[16/10] h-[220px] md:h-auto md:w-[46%] md:aspect-auto md:min-h-[320px]"
              : "aspect-[16/11] h-[196px] md:h-full md:w-[40%] md:aspect-auto",
          )}
        >
          <CardImage
            src={property.image}
        ...
        <div
          className={cn(
            "flex min-h-0 flex-1 flex-col px-5 py-5 md:px-7 md:py-6",
        ...
        >
          ...
          >
            <div className="min-w-0">
              <h3
                className={cn(
                  "font-display text-[26px] leading-[0.95] sm:text-[30px] md:text-[34px]",
          ...
          <p className="mt-3 truncate font-mono text-[11px] tracking-[0.12em] text-ink-soft uppercase">
            {property.beds} Beds • {property.baths} Baths •{" "}
            {formatNumber(property.sqft)} sqft
          </p>
          <p
            className={cn(
              "mt-3 max-w-lg text-[15px] leading-relaxed text-ink/80",
            ...
            <div className="mt-6 border-t border-ink/10 pt-6">
              ...
              <div className="mt-6 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-3">
                  <div className="relative h-12 w-12 overflow-hidden rounded-[0.9rem_0.25rem_0.9rem_0.9rem] bg-sand">
                    <Image
                      src={property.agent.photo}
